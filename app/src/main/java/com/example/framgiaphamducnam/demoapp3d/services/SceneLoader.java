package com.example.framgiaphamducnam.demoapp3d.services;
...
import com.example.framgiaphamducnam.demoapp3d.animation.Animator;
import com.example.framgiaphamducnam.demoapp3d.collision.CollisionDetection;
import com.example.framgiaphamducnam.demoapp3d.entities.Camera;
...
import com.example.framgiaphamducnam.demoapp3d.util.url.android.Handler;
import com.example.framgiaphamducnam.demoapp3d.view.ModelRenderer;
...
public class SceneLoader {
    ...
    private final Object3DData lightPoint =
            Object3DBuilder.buildPoint(lightPosition).setId("light");
    /**
        ...
        if (parent.getParamFile() != null || parent.getParamAssetDir() != null) {
            ...
            try {
                if (parent.getParamFile() != null) {
                    ...
                    //url = new URL("android://"+parent.getPackageName()+"/assets/"
                    //		+ parent.getParamAssetDir() + File.separator + parent
                    //		.getParamAssetFilename());
                    //url = new URL("android://com.example.framgiaphamducnam.demoapp3d/assets/" + parent.getParamAssetDir() + File.separator + parent.getParamAssetFilename());
            ...
            Object3DBuilder.loadV6AsyncParallel(parent, url, parent.getParamFile(),
                    parent.getParamAssetDir(), parent.getParamAssetFilename(),
                    new Object3DBuilder.Callback() {
                        ...
                        public void onBuildComplete(List<Object3DData> datas) {
                            ...
                            final String elapsed =
                                    (SystemClock.uptimeMillis() - startTime) / 1000 + " secs";
                        ...
                        public void onLoadError(Exception ex) {
                            ...
                            Toast.makeText(parent.getApplicationContext(),
                                    "There was a problem building the model: " + ex.getMessage(),
    ...
    public void translate(float dx, float dy) {
        ...
        modelRenderer.getCamera().translateCamera(dx, dy);
    }

    public void leftClickListener(boolean isClick) {
        if (isClick) {
            parent.getgLView().getModelRenderer().getCamera().MoveCameraZ((float) 3);
            translate((float)-5, (float)0.0);
        }else {
            parent.getgLView().getModelRenderer().getCamera().MoveCameraZ((float) -3);
            translate((float)5, (float)0.0);
        }
    ...
    public void headClickListener(boolean isClick) {
        Log.e("SceneLoader", "headClickListener:  -----> OK");
            //rotate(2.0f);
            ...
            //    }
            //},1000);
            parent.getgLView().getModelRenderer().getCamera().StrafeCam(3.0f, 0f);
    }
    ...
    public void loadTexture(Object3DData data, File file, String parentAssetsDir) {
        if (data.getTextureData() == null && data.getTextureFile() != null) {
            try {
                ...
                makeToastText("Problem loading texture " + data.getTextureFile(),
                        Toast.LENGTH_SHORT);
            }
        }
    }
    ...
    public void processTouch(float x, float y) {
        Object3DData objectToSelect = CollisionDetection.getBoxIntersection(getObjects(),
        ...
        if (objectToSelect != null) {
            ...
            float[] point = CollisionDetection.getTriangleIntersection2(getObjects(),
                    parent.getgLView().getModelRenderer(), x, y);
            if (point != null) {
                addObject(Object3DBuilder.buildPoint(point)
                        .setColor(new float[] { 1.0f, 0f, 0f, 1f }));
            }
        }
    }
}
