...
public abstract class Object3DImpl implements Object3D {
	...
	public Object3DImpl(String id, String vertexShaderCode, String fragmentShaderCode, String... variables) {
		...
		//String vertexCode = Utils2.loadFromAssetsFile(MyApplication.getInstance(), "models/light_vertex.glsl");
		//String fragmentCode = Utils2.loadFromAssetsFile(MyApplication.getInstance(), "models/multiple_light_fragment.glsl");
		//mProgram = Utils2.createProgram(vertexCode, fragmentCode);
	}
	...
	protected int setTexture(Object3DData obj, int textureId) {
		...
		//Log.e("Object3DImpl", "setTexture:  -----> textureId: "+textureId);
