package com.example.framgiaphamducnam.demoapp3d.collision;

import android.opengl.GLU;
import android.opengl.Matrix;
import android.util.Log;
import com.example.framgiaphamducnam.demoapp3d.entities.BoundingBox;
...
public class CollisionDetection {
    ...
    public static float[] getTriangleIntersection(List<Object3DData> objects, ModelRenderer mRenderer, float windowX, float windowY) {
        ...
        if (intersected != null) {
            Log.d("CollisionDetection", "intersected:" + intersected.getId() + ", rayOrigin:" + Arrays
                    .toString(nearHit) + ", rayVector:" + Arrays.toString(direction));
