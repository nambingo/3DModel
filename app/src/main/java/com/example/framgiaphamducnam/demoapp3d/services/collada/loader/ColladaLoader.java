package com.example.framgiaphamducnam.demoapp3d.services.collada.loader;

import android.app.Activity;
import android.opengl.GLES20;
import android.util.Log;
import com.example.framgiaphamducnam.demoapp3d.animation.Animation;
import com.example.framgiaphamducnam.demoapp3d.animation.JointTransform;
import com.example.framgiaphamducnam.demoapp3d.animation.KeyFrame;
import com.example.framgiaphamducnam.demoapp3d.controller.LoaderTask;
import com.example.framgiaphamducnam.demoapp3d.model.AnimatedModel;
import com.example.framgiaphamducnam.demoapp3d.model.Object3DBuilder;
import com.example.framgiaphamducnam.demoapp3d.model.Object3DData;
import com.example.framgiaphamducnam.demoapp3d.services.WavefrontLoader;
import com.example.framgiaphamducnam.demoapp3d.services.collada.entities.AnimatedModelData;
import com.example.framgiaphamducnam.demoapp3d.services.collada.entities.AnimationData;
import com.example.framgiaphamducnam.demoapp3d.services.collada.entities.Joint;
import com.example.framgiaphamducnam.demoapp3d.services.collada.entities.JointData;
import com.example.framgiaphamducnam.demoapp3d.services.collada.entities.JointTransformData;
import com.example.framgiaphamducnam.demoapp3d.services.collada.entities.KeyFrameData;
import com.example.framgiaphamducnam.demoapp3d.services.collada.entities.MeshData;
import com.example.framgiaphamducnam.demoapp3d.services.collada.entities.SkeletonData;
import com.example.framgiaphamducnam.demoapp3d.services.collada.entities.SkinningData;
import com.example.framgiaphamducnam.demoapp3d.services.collada.entities.Vector3f;
import com.example.framgiaphamducnam.demoapp3d.util.math.Quaternion;
import com.example.framgiaphamducnam.demoapp3d.util.xml.XmlNode;
import com.example.framgiaphamducnam.demoapp3d.util.xml.XmlParser;
...
public class ColladaLoader {
	...
	private static Object[] buildAnimatedModel(URL url) throws IOException {
		...
		for (MeshData meshData : meshDataList) {
			...
			if (meshData.getVertexWeights() != null) {
				FloatBuffer
                        floatBuffer = createNativeByteBuffer(meshData.getVertexWeights().length * 4).asFloatBuffer();
	...
	private static void populateAnimatedModel(URL url, List<Object3DData> datas, AnimatedModelData modelData) throws
            IOException {
		int counter = 0;
