package com.example.framgiaphamducnam.demoapp3d.services.wavefront;
    ...
    public static void loadAsync(final Activity parent, URL url, final File currentDir,
        ...
        new LoaderTask(parent, url, currentDir, assetsDir, modelId, callback) {
            ...
            private InputStream getInputStream() {
                ...
                try {
                    ...
                    throw new RuntimeException(
                            "There was a problem opening file/asset '" + (currentDir != null
                                    ? currentDir : assetsDir) + "/" + modelId + "'");
                }
            }
            ...
            protected List<Object3DData> build() throws IOException {
                ...
                Object3DData data3D =
                        new Object3DData(wfl.getVerts(), wfl.getNormals(), wfl.getTexCoords(),
            ...
            protected void build(List<Object3DData> datas) throws Exception {
                ...
                try {
                    ...
                    Log.e("WavefrontLoader2", "build: 33 -----> "+data.getTextureData().length);
                    publishProgress(5);
                } catch (Exception e) {
